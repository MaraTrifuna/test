 ...
 * "Titan Server 0.4.0":http://s3.thinkaurelius.com/downloads/titan/titan-server-0.4.0.zip ("signature":http://s3.thinkaurelius.com/downloads/titan/titan-server-0.4.0.zip.asc).  Contains all supported indexing backends, storage backends, the Gremlin REPL, and Rexster.  Comes with a convenience script to start Cassandra + ES + Titan + Rexster.
