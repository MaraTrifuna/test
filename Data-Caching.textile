...
Read more about [[transaction level caching | Transaction Cache]] and how to tune it.
...
Read more about [[database level caching | Database Cache]] and how to configure it.
