...
For instance, consider the scenario where user vertices have the property key @name@ which stores the full name of the user - first, middle, and last name. Defining registering the @name@ key with the standard index _and_ an external full-text index has the following advantages:
