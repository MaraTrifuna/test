...
[[images/juno-married.png|align=center]]
...
[[images/super-node.png|align=center]]
...
Read more about "Blueprints indices":https://github.com/tinkerpop/blueprints/wiki/Graph-Indices and note the following [[Titan specific limitations|Titan Limitations]]: Key indices need to be created before the key is first used.
