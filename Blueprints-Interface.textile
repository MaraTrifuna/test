...
In the code example above, two vertices were created named "Jupiter" and "Juno." Finally, these two vertices were joined in holy matrimony via a @marriedTo@ edge.
