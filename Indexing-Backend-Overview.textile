...
g.query().has("name",Cmp.EQUAL,"hercules").vertices()
// 2) Find all vertices with an age greater than 50
g.query().has("age",Cmp.GREATER_THAN,50).vertices()
// or find all vertices between 1000 (inclusive) and 5000 (exclusive) years of age
g.query().has("age",Cmp.GREATER_THAN_EQUAL,1000).has("age",Cmp.LESS_THAN,5000).vertices()
