...
The @Text@ enum specifies the [[full-text predicates| String Search]] used to query for matching text or string values. We differentiate between two types of predicates:
...
Read more about [[full-text and string search| String Search]]
