...
Read more about [[full-text and string search| String Search]] and how to specify whether to use full-text or string search.
...
Also, read more about how to configure [[full-text and string search | String Search]] and how to [[directly query an indexing backend | direct index query]] for more search functionality and result scoring support.