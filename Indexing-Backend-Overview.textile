...
When using Titan's standard index, the name argument to the @indexed()@ method is optional. An equivalent definition of the _name_ property key, which identifies the standard index by its name, would be:
