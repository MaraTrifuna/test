...
For example, the following property key definitions register all the indexed properties from the [[Graph of the Gods example|Getting Started]] with the respective index backends.
