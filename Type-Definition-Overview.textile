...
| @unique(Direction, lock)@ | Configures the type to be unique in the given direction with the specified consistency guarantee (either @LOCK@ or @NO_LOCK@). | Label and Key | not functional | @TitanType.isUnique(Direction)@ |
