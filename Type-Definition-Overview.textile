...
If a type is used in the primary key, it cannot be part of the signature. As before, @TitanTypes@ used in the signature must be either out-unique property keys or out-unique, unidirected edge labels.
