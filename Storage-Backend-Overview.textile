...
| Cassandra | _cassandra_ or _astyanax_ | eventually consistent | highly available | linear scalability | yes |
| HBase | _hbase_ | vertex consistent | single point of failure | linear scalability | yes |
| BerkeleyJE | _berkeleyje_ | "ACID":http://en.wikipedia.org/wiki/ACID | single point of failure | single machine | HA mode available |
