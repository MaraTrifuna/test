...
Rexster can be downloaded at "this location":https://github.com/tinkerpop/rexster/wiki/Downloads. Below is a snippet of shell commands that demonstrate the process for getting Rexster downloaded and started using a default configuration.  Be sure to check the TinkerPop [[Version Compatibility]] for the Titan version you are using prior to download.
