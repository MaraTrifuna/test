...
There are two ways to configure Rexster for use with Titan:

# If building Titan from source, copy the @target/titan-0.1-SNAPSHOT-jar-with-dependencies.jar@ to the Rexster @ext@ directory.
# If using the Titan zipped distribution download, copy all jar files in the @lib@ directory to the Rexster @ext@ directory.
