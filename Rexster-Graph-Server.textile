...
```bash
$ curl -L https://github.com/downloads/tinkerpop/rexster/rexster-server-2.0.0.zip > rexster-server-2.0.0.zip
  % Total    % Received % Xferd  Average Speed   Time    Time     Time  Current ...
...
$ unzip rexster-server-2.0.0.zip
Archive:  rexster-server-2.0.0.zip
   creating: rexster-server-2.0.0/
...
$ cd rexster-server-2.0.0
