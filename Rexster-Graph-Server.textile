...
# If building Titan from source, copy the @target/titan-0.1-SNAPSHOT-jar-with-dependencies.jar@ to the Rexster @./rexster-server/target/rexster-server-${VERSION}/ext@ directory.
