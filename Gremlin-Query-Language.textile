...
The query above can be read:
  ...
  # @out('father')@: traverse outgoing father edge's from Hercule's father's vertex (i.e. Jupiter).
...
Note this more complex, related traversal that shows the entire father family tree branch of Hercules. This more complicated traversal is provided into order to demonstrate the flexibility and expressivity of the language. A competent grasp of Gremlin provides the Titan user the ability to fluently navigate the underlying graph structure.
...
Some self-explanatory traversals are provided below to provide a flavor of how to navigate a graph with Gremlin.
