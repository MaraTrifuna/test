...
This configuration has one HBase master server in charge of three HBase regionservers.  Titan connects only to the master, which in turn communicates with the others.
