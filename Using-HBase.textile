...
The following steps use Whirr to start a four-node HBase cluster on EC2 and run a basic Titan test case against it.
...
* (download attached hbase-ec2-0.92.1.properties to the recipes/ directory)
