...
```java
graph.makeKey("booksummary").dataType(String.class).indexed("search",Vertex.class,com.thinkaurelius.titan.core.Parameter.of(Mapping.MAPPING_PREFIX,Mapping.TEXT)).make()
```
...
```java
graph.makeKey("bookname").dataType(String.class).indexed("search",Vertex.class,com.thinkaurelius.titan.core.Parameter.of(Mapping.MAPPING_PREFIX,Mapping.STRING)).make()
```
