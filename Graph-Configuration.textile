...
|_. Option |_. Description |_. Value |_. Default |_. Modifiable |
| autotype | Specifies the factory to use when automatically creating types. See "Default Type Creation":Type-Definition-Overview#default-type-creation for more details.  | _blueprints_ or _none_ | _blueprints_ | Yes |
