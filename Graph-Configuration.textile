...
| storage.backend | Full class name of the @StorageManager@ implementation defining the storage backend to be used for persistence or one of the following pre-defined storage backends: *cassandra*, *hbase*, *local* | Class name or short-hand | *local* | no |
