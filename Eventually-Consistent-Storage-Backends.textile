...
* *Ghost Vertices*: <br />
If a vertex gets deleted while it is concurrently being modified, the vertex might re-appear as a _ghost_.

* *Stale Index entries*: <br />
...
* *Buffer Size:* <br />
Configure the buffer-size in the [[graph configuration | Graph Configuration]] to be large enough for all mutations in a transaction. This will reduce the likelihood of partial mutations causing inconsistencies.
* *Existence checks:* <br />
...
* *Regular clean-ups:* <br />
Run regular batch-jobs to repair inconsistencies in the graph using [[Faunus | Global Graph Analytics]].
