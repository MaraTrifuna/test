...
| primaryKey(TitanType...) | Configures the composite primary key for this type. | Label | none | - |
| signature(TitanType...) | Configures the signature of this type. | Label | none | - |
