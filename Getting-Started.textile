...
Gremlin is a graph traversal language that can be used with any Blueprints-enabled graph database. For a more in-depth review of Gremlin and Titan, please see the respective [[Gremlin Graph Traversals]] section of this documentation. For now, some simple Gremlin examples are provided to demonstrate how to interact with Titan via a "REPL":http://en.wikipedia.org/wiki/Read%E2%80%93eval%E2%80%93print_loop (i.e. an interactive shell).
