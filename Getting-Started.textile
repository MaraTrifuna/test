...
The remainder of "this documentation":https://github.com/thinkaurelius/titan/wiki discusses more in-depth examples and configurations for using Titan. Specifically,
