...
Titan can be installed by downloading a distribution from the "Downloads":https://github.com/thinkaurelius/titan/downloads section or by importing Titan into a larger "Maven":http://maven.apache.org/ project. 
...
bq. "Hercules":http://en.wikipedia.org/wiki/Hercules, son of Jupiter and "Alcmene":http://en.wikipedia.org/wiki/Alcmene, bore super human strength. To atone for the slaying of his children and wife, Hercules was ordered by the "Oracle of Delphi":http://en.wikipedia.org/wiki/Oracle_at_Delphi to serve "Eurystheus":http://en.wikipedia.org/wiki/Eurystheus. Hercules was appointed 12 labors.
...
gremlin> hercules.outE('battled').has('time',T.gt,1).name
==>null
==>null
