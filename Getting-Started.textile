...
This page makes use of a toy graph distributed with Titan called _The Graph of the Gods_. This graph is diagrammed below. Notice that it is composed of a heterogenous set of vertices and edges that outline the relationships between the beings and places within the Roman pantheon. The raw _The Graph of the Gods_ "GraphML":http://graphml.graphdrawing.org/ file is available at "this location":https://github.com/thinkaurelius/titan/blob/master/data/graph-of-the-gods.xml.
