...
Titan can be downloaded from the "Downloads":https://github.com/thinkaurelius/titan/downloads section. Once retrieved and unpacked, a "Gremlin":http://gremlin.tinkerpop.com terminal can be started. Commands can now be issued to Titan. 
...
The Gremlin terminal is Groovy shell and as such, it is possible to issue Java statements in a real-time, interactive fashion.
