...
This page will make use of the following toy graph deployed with Titan. The toy graph is called The Graph of the Gods and it provides a collection of heterogenous vertices and edges that outline the relationships between the beings and places within the Roman pantheon and its ancient saga.

[[https://github.com/thinkaurelius/titan/raw/master/doc/images/graph-of-the-gods.png|align=center]]

h2. Installing Titan

Titan can be installed by downloading a distributed from the "Downloads":https://github.com/thinkaurelius/titan/downloads section.
