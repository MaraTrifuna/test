...
The Gremlin terminal is "Groovy":http://groovy.codehaus.org/ shell and as such, it is possible to issue Java statements in a real-time, interactive fashion.
