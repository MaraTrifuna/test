...
Vertex v2 = g.createVertex(null);
v2.setProperty("uniqueName","foo");
g.addEdge(null,v1,v2,"related");
//Do many other things
g.stopTransaction(Conclusion.SUCCESS); // Likely to fail due to lock congestion
```
...
//Do many other things
TransactionalGraph tx = g.startTransaction();
Vertex v2 = tx.createVertex(null);
v2.setProperty("uniqueName","foo");
